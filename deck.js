...
function go(i) {
  ...
  /* sub-step: layer stack on slide 2 */
  if (cur === 2) {
...
function runA(i) {
  ...
  switch (i) {
    ...
    case 1:
      ...
      break;
    case 2: {
      /* what we are building: isometric layer stack */
      var fromFuture = _prevCur > 2;
    ...
    case 3:
      /* what we hand you: 4-card grid */
      anime({
        targets: "#s3 [style*='grid-template-columns: 1fr 1fr'] > div",
        translateY: [14, 0],
        opacity: [0, 1],
        duration: 450,
      ...
      break;
    case 4:
      /* we're venture backed: trajectory chart */
      anime({
        targets: "#s4 h2, #s4 > div > p",
        translateY: [12, 0],
        opacity: [0, 1],
        duration: 500,
      ...
      break;
    case 5:
      /* close: become an office hours host */
      anime({
        targets: "#s5 h1",
        translateY: [12, 0],
        opacity: [0, 1],
